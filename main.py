...
def watermark_to_disk(imgs, output_folder, watermark_list):
...
def main(): 
    ...
    watermark_to_disk(imgs, "output/facebook", possible_water_marks)

    imgs = tumblr.get_image_from_profile("sweetoothgirl", max=3)
    watermark_to_disk(imgs, "output/tumblr", possible_water_marks)
